...
<div id="svw_slider">
    ...
    <div id = "carousel1" style="width:960px; height:240px;background:none;overflow:scroll; margin-top: 20px">            
...
<div id="svw_main"> 
	...
	<div class="col one_fourth gallery_box" style="background: #f2f2f2;padding: 7px 5px 0;border-bottom: 1px solid #ebebeb;
    margin-bottom: 15px;">
