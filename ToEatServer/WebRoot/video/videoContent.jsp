...
<script type="text/JavaScript" src="<%=path%>/js/jquery.mousewheel.js"></script>  
 ...
 <!-- Flow Player -->
        <script type="text/javascript" src="video/videoplayer/flowplayer-3.2.8.min.js"></script>
</head>
    	...
    	<div class="post">
            ...
            <div id="player_window">
	            <c:choose>
					...
					app=arr[3];
					playpath=arr[4];
			            flowplayer("player", "video/videoplayer/flowplayer-3.2.8.swf",{  
				            clip: {  
				              //scaling:'orig',
				              url: playpath, 
				              provider: 'rtmp',
				            ...
				            plugins: {   
				               rtmp: {   
				                 url: 'video/videoplayer/flowplayer.rtmp-3.2.8.swf',   
