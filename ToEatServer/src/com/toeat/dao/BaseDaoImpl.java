...
//				System.out.println("ReadSingle……query...."+query);
	...
	@Override
	public Object ReadSingleByDouble(final String targetName,final String propertyName,final Object value,final String propertyName2,final Object value2) {
		// TODO Auto-generated method stub
		return (Object) getHibernateTemplate().execute(new HibernateCallback<Object>() {
			/*doInHibernate()。session的创建和销毁，一切都在程序内部完成。*/
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				String hql = "from "+targetName+" as "+targetName+" where "+targetName+"." + propertyName + "=:value and "
													  					   +targetName+"." + propertyName2 +"=:value2 " ;
				Query query = session.createQuery(hql);
				query.setParameter("value", value);
